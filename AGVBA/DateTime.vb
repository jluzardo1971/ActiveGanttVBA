...
Public Class DateTime
    ...
    Public Shared ReadOnly Property Now() As AGVBA.DateTime
        Get
            Dim dtResult As AGVBA.DateTime = New AGVBA.DateTime()
    ...
    Public Shared Operator =(ByVal DateTime1 As AGVBA.DateTime, ByVal DateTime2 As AGVBA.DateTime) As Boolean
    ...
    Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
        If obj Is Nothing Or Not Me.GetType() Is obj.GetType() Then
            Return False
        End If
        Dim DateTime2 As AGVBA.DateTime = CType(obj, AGVBA.DateTime)
    ...
    Public Overloads Function Equals(ByVal DateTime2 As AGVBA.DateTime) As Boolean
        If ((mp_dtDateTime = DateTime2.mp_dtDateTime) And (mp_lSecondFraction = DateTime2.mp_lSecondFraction)) Then
            Return True
        Else
            Return False
