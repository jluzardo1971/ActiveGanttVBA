...
Public Class clsTimeBlocks
    ...
    Private mp_dtIntervalStart As AGVBA.DateTime
    Private mp_dtIntervalEnd As AGVBA.DateTime
    ...
    Friend Sub New(ByVal Value As ActiveGanttVBACtl)
        ...
        mp_dtIntervalStart = New AGVBA.DateTime()
        mp_dtIntervalEnd = New AGVBA.DateTime()
    ...
    Friend Sub CreateTemporaryTimeBlocks()
        ...
        For lIndex = 1 To Count
            ...
            Dim dtTimeLineStart As AGVBA.DateTime = New AGVBA.DateTime()
            Dim dtTimeLineEnd As AGVBA.DateTime = New AGVBA.DateTime()
            Dim dtCurrent As AGVBA.DateTime = New AGVBA.DateTime()
            Dim dtStartBuff As AGVBA.DateTime = New AGVBA.DateTime()
            Dim dtEndBuff As AGVBA.DateTime = New AGVBA.DateTime()
            Dim dtBase As AGVBA.DateTime
            Dim dtStartDate As AGVBA.DateTime = New AGVBA.DateTime()
            Dim dtEndDate As AGVBA.DateTime = New AGVBA.DateTime()
    ...
    Public Property IntervalStart() As AGVBA.DateTime
        Get
            Return mp_dtIntervalStart
        End Get
        Set(ByVal value As AGVBA.DateTime)
            mp_dtIntervalStart = value
        End Set
    End Property

    Public Property IntervalEnd() As AGVBA.DateTime
        Get
