...
Public Class clsPredecessor
    ...
    Friend Sub New(ByVal Value As ActiveGanttVBACtl, ByVal oPredecessors As clsPredecessors)
        mp_oControl = Value
        mp_bVisible = True
    ...
    Public Sub Check(ByVal Mode As E_PREDECESSORMODE)
        Dim dtPredecessor As AGVBA.DateTime = New AGVBA.DateTime()
        Dim dtSuccessor As AGVBA.DateTime = New AGVBA.DateTime()
