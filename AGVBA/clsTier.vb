...
Public Class clsTier
    ...
    Friend Sub New(ByVal Value As ActiveGanttVBACtl, ByVal oTierArea As clsTierArea, ByVal yTierPosition As E_TIERPOSITION)
        mp_oControl = Value
    ...
    Private Sub Draw(ByVal dtStart As AGVBA.DateTime, ByVal dtEnd As AGVBA.DateTime, ByVal lTop As Integer, ByVal lBottom As Integer)
