...
Public Class clsProgressLine
    ...
    Private mp_dtPosition As AGVBA.DateTime
    Private mp_yLength As E_PROGRESSLINELENGTH
    Private mp_yLineType As E_PROGRESSLINETYPE
    Private mp_oTimeLine As clsTimeLine

    Friend Sub New(ByVal Value As ActiveGanttVBACtl, ByVal oTimeLine As clsTimeLine)
        mp_oControl = Value
        mp_clrForeColor = Color.Red
        mp_dtPosition = New AGVBA.DateTime()
    ...
    Public Property Position() As AGVBA.DateTime
        Get
    ...
    Friend Sub Draw()
        ...
        Dim dtDate As New AGVBA.DateTime()
