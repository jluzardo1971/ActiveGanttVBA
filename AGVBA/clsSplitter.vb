...
Public Class clsSplitter
    ...
    Public Sub SetColor(ByVal Index As Integer, ByVal oColor As Color)
        ...
        If mp_yType <> E_SPLITTERTYPE.SA_USERDEFINED Then
            mp_oControl.mp_ErrorReport(SYS_ERRORS.SPLITTER_INVALIDOP, "Invalid Operation", "ActiveGanttVBACtl.clsSplitter.SetColor")
            Return
        End If
        If Index < 0 Then
            mp_oControl.mp_ErrorReport(SYS_ERRORS.SPLITTER_INVALID_INDEX, "Invalid Index", "ActiveGanttVBACtl.clsSplitter.SetColor")
            Return
        End If
    ...
    Public Function GetColor(ByVal Index As Integer) As Color
        Index = Index - 1
        If mp_yType <> E_SPLITTERTYPE.SA_USERDEFINED Then
            mp_oControl.mp_ErrorReport(SYS_ERRORS.SPLITTER_INVALIDOP, "Invalid Operation", "ActiveGanttVBACtl.clsSplitter.GetColor")
            Return Nothing
        End If
        If Index < 0 Then
            mp_oControl.mp_ErrorReport(SYS_ERRORS.SPLITTER_INVALID_INDEX, "Invalid Index", "ActiveGanttVBACtl.clsSplitter.GetColor")
            Return Nothing
        End If
        If Index > mp_aColors.Count - 1 Then
            mp_oControl.mp_ErrorReport(SYS_ERRORS.SPLITTER_INVALID_INDEX, "Invalid Index", "ActiveGanttVBACtl.clsSplitter.GetColor")
    ...
    Public Property Width() As Integer
        ...
        Set(ByVal Value As Integer)
            ...
            Else
                If Value < 0 Then
                    mp_oControl.mp_ErrorReport(SYS_ERRORS.SPLITTER_INVALID_WIDTH, "Invalid Width Value", "ActiveGanttVBACtl.clsSplitter.Width")
                    Return
                End If
                mp_lWidth = Value
            End If
            ...
            If mp_yType = E_SPLITTERTYPE.SA_APPEARANCE Then
                ...
                Select Case mp_yAppearance
                    ...
                    Case E_BORDERSTYLE.TLB_SINGLE
                        mp_aColors.Item(0) = Color.Black
                        mp_aColors.Item(1) = Color.FromArgb(255, 192, 192, 192)
                        mp_aColors.Item(2) = Color.FromArgb(255, 192, 192, 192)
                        mp_aColors.Item(3) = Color.FromArgb(255, 192, 192, 192)
                        mp_aColors.Item(4) = Color.FromArgb(255, 192, 192, 192)
                        mp_aColors.Item(5) = Color.Black
                End Select
            End If
