...
Public Class clsNode
    ...
    Friend Sub New(ByVal Value As ActiveGanttVBACtl, ByVal oRow As clsRow)
        mp_oControl = Value
        mp_oRow = oRow
        mp_lDepth = 0
        mp_bExpanded = True
    ...
    Friend ReadOnly Property mt_TextLeft() As Integer
        Get
            ...
            ElseIf CheckBoxVisible = True And ImageVisible = True Then
                Return Left + 28 + mp_oImage.Width + 5
            ElseIf CheckBoxVisible = True Then
                Return Left + 28
            ElseIf ImageVisible = True Then
                Return Left + 10 + mp_oImage.Width + 5
            End If
            Return 0
        End Get
    End Property
    ...
    Friend ReadOnly Property ImageLeft() As Integer
        Get
            If ImageVisible = True And mp_oControl.Treeview.Images = True Then
                Return mt_TextLeft - 3 - mp_oImage.Width
            Else
                Return 0
            End If
        End Get
    ...
    Friend ReadOnly Property ImageTop() As Integer
        Get
            If ImageVisible = True And mp_oControl.Treeview.Images = True Then
                Return YCenter - (mp_oImage.Height / 2)
            Else
                Return 0
            End If
        End Get
    ...
    Friend ReadOnly Property ImageRight() As Integer
        Get
            If ImageVisible = True And mp_oControl.Treeview.Images = True Then
                Return ImageLeft + mp_oImage.Width
            Else
                Return 0
            End If
        End Get
    ...
    Friend ReadOnly Property ImageBottom() As Integer
        Get
            If ImageVisible = True And mp_oControl.Treeview.Images = True Then
                Return ImageTop + mp_oImage.Height
            Else
                Return 0
            End If
        End Get
