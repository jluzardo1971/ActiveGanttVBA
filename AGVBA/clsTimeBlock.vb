...
Public Class clsTimeBlock
    ...
    Private mp_dtBaseDate As AGVBA.DateTime
    ...
    Friend Sub New(ByVal Value As ActiveGanttVBACtl)
        ...
        mp_dtBaseDate = New AGVBA.DateTime()
    ...
    Public Property Visible() As Boolean
        Get
            ...
            If mp_yTimeBlockType = E_TIMEBLOCKTYPE.TBT_RECURRING Then
                Return False
            End If
            Dim dtStartDate As AGVBA.DateTime
            Dim dtEndDate As AGVBA.DateTime
    ...
    Public Property BaseDate() As AGVBA.DateTime
        Get
            Return mp_dtBaseDate
        End Get
