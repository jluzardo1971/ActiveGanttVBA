...
Public Class clsTimeLine
    ...
    Private mp_dtStartDate As AGVBA.DateTime
    Private mp_lEnd As Integer
    Private mp_lStart As Integer
    Private mp_oStyle As clsStyle


    Friend Sub New(ByVal Value As ActiveGanttVBACtl, ByVal oView As clsView)
        mp_oControl = Value
        mp_oView = oView
        ...
        Dim dtTimeNow As AGVBA.DateTime = New AGVBA.DateTime()
    ...
    Public ReadOnly Property EndDate() As AGVBA.DateTime
        Get
            Calculate()
    ...
    Public ReadOnly Property StartDate() As AGVBA.DateTime
        Get
            Return mp_dtStartDate
        End Get
    End Property

    Friend WriteOnly Property f_StartDate() As AGVBA.DateTime
    ...
    Public Sub Position(ByVal TimeLineStartDate As AGVBA.DateTime)
