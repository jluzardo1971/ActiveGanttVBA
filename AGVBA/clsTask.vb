...
Public Class clsTask
    ...
    Private mp_dtEndDate As AGVBA.DateTime
    ...
    Public Sub New(ByVal Value As ActiveGanttVBACtl)
        ...
        mp_dtEndDate = New AGVBA.DateTime()
        mp_dtEndDate.SetToCurrentDateTime()
        mp_dtStartDate = New AGVBA.DateTime()
        mp_sText = ""
        mp_sLayerIndex = "0"
    ...
    Public Property RowKey() As String
        ...
        Set(ByVal Value As String)
            If mp_oControl.Rows.oCollection.m_bDoesKeyExist(Value) = False Then
                mp_oControl.mp_ErrorReport(SYS_ERRORS.INVALID_ROW_KEY, "Invalid Row Key (""" & Value & """)", "ActiveGanttVBACtl.clsTask.Let RowKey")
                Exit Property
            End If
            mp_sRowKey = Value
    ...
    Public Property StartDate() As AGVBA.DateTime
        Get
    ...
    Public Property EndDate() As AGVBA.DateTime
        Get
            Return mp_dtEndDate
        End Get
        Set(ByVal Value As AGVBA.DateTime)
