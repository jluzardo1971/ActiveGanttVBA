...
Public Class clsHScrollBarTemplate
    ...
    Friend Sub Initialize(ByVal oControl As ActiveGanttVBACtl)
    ...
    Friend Function ScrollBarClick(ByVal X As Integer, ByVal Y As Integer) As Boolean
    ...
    Friend Sub LoadViewState(ByVal oState As Object)
        mp_lMin = oState(0)
        mp_lMax = oState(1)
        mp_lValue = oState(2)
    End Sub
