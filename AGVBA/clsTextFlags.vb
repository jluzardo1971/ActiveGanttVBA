...
Public Class clsTextFlags
    ...
    Friend Function GetFlags() As StringFormat
        ...
        If mp_bRightToLeft = True Then
            oReturn.FormatFlags = oReturn.FormatFlags Or Drawing.StringFormatFlags.DirectionRightToLeft
        End If
        Return oReturn
    End Function
